...
@mcp.tool()
def create_bell_state(backend: str = 'qiskit', shots: int = 1000) -> Dict[str, Any]:
    """
...
@mcp.tool()
def create_ghz_state(num_qubits: int, backend: str = 'qiskit', shots: int = 1000) -> Dict[str, Any]:
    """
...
@mcp.tool()
def quantum_teleportation(backend: str = 'qiskit', shots: int = 1000) -> Dict[str, Any]:
    """
